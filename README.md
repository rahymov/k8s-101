...
kubectl apply -f hello-react-deploy-svc.yaml # create hello service type of NodePort
...
kubectl get nodes -owide  # get node ip address

kubectl get svc -owide # get the port
